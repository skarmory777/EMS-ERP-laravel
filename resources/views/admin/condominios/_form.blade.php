    <form role="form" action="{{ $customer->exists
        ? route('admin.condominios.update', ['customer' => $customer->getKey()])
        : route('admin.condominios.store') }}" method="POST">
        ...
        <div class="card-footer">
            ...
            <a class="btn btn-light" href="{{ route('admin.condominios.index') }}"><i class="fa fa-arrow-left"></i> {{ __('messages.go_back') }}</a>
        </div>
