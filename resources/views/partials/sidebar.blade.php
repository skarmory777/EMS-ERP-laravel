<nav id="sidebarMenu" class="sidebar d-md-block bg-primary text-white collapse" data-simplebar>
    <div class="sidebar-inner pt-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item {{ Request::segment(2) == 'condominios' ? 'active' : '' }}"><a href="{{ route('admin.condominios.index') }}" class="nav-link"><span class="sidebar-icon"><span class="fas fa-star"></span></span> <span>Condominio</span></a></li>
            <li class="nav-item {{ Request::segment(2) == 'condominios' ? 'active' : '' }}"><a href="{{ route('admin.condominios.index') }}" class="nav-link"><span class="sidebar-icon"><span class="fas fa-star"></span></span> <span>Unidade</span></a></li>            
            <li class="nav-item {{ Request::segment(2) == 'condominios' ? 'active' : '' }}"><a href="{{ route('admin.condominios.index') }}" class="nav-link"><span class="sidebar-icon"><span class="fas fa-star"></span></span> <span>Síndico</span></a></li>
            <li class="nav-item {{ Request::segment(2) == 'condominios' ? 'active' : '' }}"><a href="{{ route('admin.condominios.index') }}" class="nav-link"><span class="sidebar-icon"><span class="fas fa-star"></span></span> <span>Contrato de Administração</span></a></li>
